...
//typedefs
export typedef struct direct_light_struct
{
...
export typedef struct point_light_struct
{
...
export typedef struct spot_light_struct
{
...
export struct controller_window
{
...
export controller_window* getControllerWindow(unsigned ID)
{
...
export std::optional<unsigned> getWindowID(GLFWwindow* window)
{
...
export std::string get_top_folder(std::string path)
{
...
export void createControllerWindow(std::string title, std::string model_path, GLFWwindowclosefun window_closed_callback)
{
	controller_window w;
...
export controller_window* getLastWindow()
{
	return &windows.back();
}

export void controller_window_input()
{
	SDL_PumpEvents();
	for (unsigned i = 0; i < windows.size(); ++i)
	{
...
export void controller_sdl_events(SDL_Event* event)
{
...
export void drawControllerWindows()
{
	for (controller_window& w : windows)
	{
