...
export void createSettingsWindow()
{
	glfwInit();
...
export void removeSettingsWindow()
{
...
export void settings_window_input(bool& quit)
{
...
export void settings_sdl_events(SDL_Event* event)
{
//Maybe used later
}
...
export void drawSettingsWindow()
{
	glfwMakeContextCurrent(glfw_settings_window);
	glfwSwapInterval(1);
